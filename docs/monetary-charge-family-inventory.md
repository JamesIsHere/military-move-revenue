...
| 2 | Item 4 reweigh fee | `Additional Rates!A3:E3`: 125.00 USD. Item 4.4 requires billing through 226A with the note `reweigh fee`, not through 4A/4B, and disallows discount. | Item 4.5 makes payment conditional on initial-versus-reweigh results and tolerance. Decision 0006 / `INT-0003` now supplies the scoped 2026 initial-net branch selector, backed by reviewed ticket and workflow evidence. | Eligibility is published without money. `CF-0001` and `CF-0003` still leave the scoped rate-date and current 226A/4A/4B billing contract unresolved. |
