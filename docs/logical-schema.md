...
| `CF-0004` — reweigh 5,000-lb branch input | Applying the selector outside `INT-0003`'s 2026 scope or after contrary authority is archived | Use final reviewed initial net for the approved eligibility rules; preserve all observations and historical conflict-held records |
